    ...
    <section ref={sectionRef} className="relative min-h-screen bg-white flex items-center pt-16 overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto px-6 w-full py-16">
        ...
        >
          ...
          {/* Name */}
          <motion.h1 variants={itemVariants} className="text-5xl md:text-7xl font-bold text-slate-900 mb-3 leading-none tracking-tight">
            Phaneendra{' '}
          ...
          {/* Location + email */}
          <motion.div variants={itemVariants} className="flex items-center gap-4 mb-6 text-sm text-slate-400">
