...
export default function MinimalProjectCard({ project, index = 0 }: { project: Project; index?: number }) {
  return (
    <motion.div
    ...
    >
      <TiltCard
        ...
        className="group p-5 border border-slate-100 rounded-xl bg-white hover:border-indigo-200 hover:shadow-md transition-all h-full"
      >
